...
import com.example.meetup.scanner.util.QrGenerator;
...
public class QrDialogFragment extends DialogFragment {
    ...
    EventsInfoSharedViewModel shareViewModel;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        if (member != null) {
            qrCode = QrGenerator.generateQR( requireContext(),member, memberId, current_event_id);
